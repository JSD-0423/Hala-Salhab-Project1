...
function SearchBar({filterOptions, sortOptions}) {
    return (
        <section className="container-fluid d-flex justify-content-center mt-4">
            ...
            {/* <input type="search" placeholder="Search the website..." className="col border border-0 ms-3 my-2 z-1 " /> */}
                ...
                <div className="col-12 col-lg-3">
                    <div className="row">
                        <div className="col-6 border-md-start border-top d-flex flex-column justify-content-around pe-0">
                            <SelectList name="sort" id="sort" label="Sort by:" options={sortOptions} />
                        </div>
                        <div className="col-6 border-start border-top d-flex flex-column justify-content-around pe-0">
                            <SelectList name="filter" id="filter" label="Filter by:" options={filterOptions}/>
                        </div>
                    </div>
                </div>
            </div>
