...
function SearchBar({ filterOptions, sortOptions, handleSearch, handleSort, handleFilter, searchValue, setSearchData }) {
    ...
    const searchBarClassName = theme === 'dark'
        ? 'search-bar-dark container row align-items-center shadow-sm rounded-3 px-0'
        : 'search-bar-light container row align-items-center shadow-sm rounded-3 px-0';
    ...
    return (
        <section className="container-fluid d-flex justify-content-center mt-4">
            <div className={searchBarClassName} id="search-bar">
